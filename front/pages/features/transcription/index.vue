        ...
        <div class="max-w-5xl mx-auto">
          <div class="flex flex-col lg:flex-row items-start gap-12">
            ...
            <div class="lg:w-3/5 w-full">
              ...
              <div
                v-if="error"
                class="bg-red-50 border border-red-200 text-red-700 p-4 rounded-xl mt-4"
              >
...
const transcribeFile = async () => {
  ...
  try {
    ...
    const response = await apiClient.post("/api/trans/transcribe", formData, {
      headers: {
...
const downloadTranscript = () => {
  if (!transcriptionResult.value || !transcriptionResult.value.transcript)
    return;
